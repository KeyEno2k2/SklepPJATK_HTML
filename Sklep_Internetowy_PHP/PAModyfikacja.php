...
<!----------------------------------------------------------------------------------------------->
    ...
    <div class=""mt-5 mb-5 border p-4 bg-dark shadow">
        <div class="mt-3">
            <center><button class="btn btn-danger" style="width: 300px"><a href="DodawaniePrzedmiotu.php">Dodawanie Produktu/Producenta</button></a></center>
            <p></p>
            <center><button class="btn btn-danger" style="width: 300px"><a href="UsuwaniePrzedmiotu.php">Usuń Produkt</button></a></center>
            <p></p>
            <center><button class="btn btn-danger" style="width: 300px"><a href="UsuwanieUzytkownika.php">Usuń Użytkownika</button></a></center>
            <p></p>
            <center><button class="btn btn-danger" style="width: 300px"><a href="DodajIlosc.php">Dodaj Ilość Produktów</button></a></center>
            <p></p>
            <center><button class="btn btn-danger" style="width: 300px"><a href="UsuwanieOpini.php">Usuń Opinie</button></a></center>
        </div>
    </div>
<!----------------------------------------------------------------------------------------------->
<!-- LINIA DOLNA -->
