...
<div class="text-center">
    <form action="" method="post" class="mt-5 mb-5 border p-4 bg-light shadow" style="max-width: 1820px; margin: auto;">
        <form class="text-center">
            <h3 class="mb-4 text-secondary">Dodaj Ilość Produktów</h3>
            <div class="mb-3 col-md">
                <select class="form-select-lg mb-3" name="DODAJILOSC" aria-label="Typ Produktu">
<?php
...
?>
            ...
            <input type="number" name="LICZBA" placeholder="Podaj liczbe dodawanych produktów" style="width: 500px">
            <?php
            if(isset($_POST['LICZBA'])){
            $sql = "UPDATE produkty SET Ilosc = Ilosc + ".$_POST['LICZBA']." WHERE ID =".$_POST['DODAJILOSC'];
            if($db -> update($sql) === TRUE ){
                echo "<h1>Pomyślnie Dodano Ilość Produktów do listy</h1>";
            }else{
                echo "<h1>Błąd przy dodawaniu ilości produktów !!!</h1>";
            }
            }
            ?>
