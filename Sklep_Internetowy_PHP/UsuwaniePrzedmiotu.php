...
<div class="text-center">
    <form action="" method="post" class="mt-5 mb-5 border p-4 bg-light shadow" style="max-width: 1820px; margin: auto;">
        <form class="text-center">
            <h3 class="mb-4 text-secondary">Usuń Produkt</h3>
            <div class="mb-3 col-md">
                <select class="form-select-lg mb-3" name="PRODUKT" aria-label="Typ Produktu">
                    <?php
            ...
            <div class="mt-3" style="margin-bottom: 100px">
                ...
                if(isset($_POST['PRODUKT'])){
                    $sql="DELETE FROM produkty WHERE ID ='".$_POST['PRODUKT']."'";
                    if($conn -> query($sql) === TRUE){
                        echo "<h1>Pomyślnie Usunięto Produkt z listy</h1>";
                    } else {
                        echo "<h1>Błąd przy Usuwaniu Produktu z listy</h1>";
                    }
                }
                mysqli_close($conn);
                ?>
